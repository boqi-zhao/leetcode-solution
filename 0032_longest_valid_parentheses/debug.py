...
def test_edge_case_fully_valid():
    """测试边界情况 - 整个字符串有效"""
    solution = Solution()
    s = "()(())"
    expected = 6
...
def test_edge_case_valid_prefix_only():
    """测试边界情况 - 仅前缀有效"""
    solution = Solution()
    s = "()(()"
    expected = 2
...
if __name__ == '__main__':
    ...
    # test_edge_case_fully_valid()        # 运行边界情况 - 整个字符串有效
    # test_edge_case_valid_prefix_only()  # 运行边界情况 - 仅前缀有效
    # test_custom()      # 运行自定义测试
